...
# Update the route /renameAccount to add the account name while creating new account. 
@app.route("/createAccount", methods=["GET", "POST"])
def createAccount():
    global account, myWallet
    username = myWallet.username
    
    # Check if there is a POST request from the web page.  

        #Get the newAccountName from the web page using request.form.get() method
    
    
        #If new_account_name is recived, pass the accountName as new_account_name 

            # Else pass the accountName as None 
